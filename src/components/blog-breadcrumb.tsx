            ...
            <BreadcrumbItem>
              <BreadcrumbLink asChild>
                <Link className="hover:underline" href="/blog">
                  <h1 className={`font-medium leading-none m-0 p-0 tracking-tighter duration-700 transition-all ease-out ${isProjectsPage ? "scale-150 ml-3" : "scale-100 ml-0"}`}>Blog</h1>
                </Link>
              </BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
