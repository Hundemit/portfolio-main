...
const navbarbuttonstyle = cn(buttonVariants({ variant: "ghost", size: "icon" }), "size-12 aspect-square rounded-xl text-gray-900 dark:text-gray-100 hover:bg-background/30 rounded-full");
