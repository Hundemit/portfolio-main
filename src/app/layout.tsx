    ...
    <html className="scroll-smooth" lang="en" suppressHydrationWarning>
      <body className={cn("relative min-h-screen bg-background font-sans antialiased max-w-2xl mx-auto rounded-xl  duration-1000", fontSans.variable)} suppressHydrationWarning>
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
          ...
          <div
            id="noise-background"
            className="rounded-3xl fixed inset-0 w-screen h-screen z-[100] pointer-events-none opacity-[0.05] [background-image:url('/background1.gif')] [background-repeat:repeat,no-repeat] [background-position:0_0,0_0] [background-size:auto,cover] "
          />
          {children}
          <Navbar />
        </ThemeProvider>
