    ...
    <html className="scroll-smooth" lang="en" suppressHydrationWarning>
      <body className={cn("relative min-h-screen bg-background font-sans antialiased max-w-2xl mx-auto", fontSans.variable)} suppressHydrationWarning>
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
          ...
          <div className="rounded-3xl fixed inset-0 w-screen h-screen z-20 pointer-events-none opacity-[0.03] [background-image:url('/background.gif')] [background-repeat:repeat,no-repeat] [background-position:0_0,0_0] [background-size:auto,cover] " />
